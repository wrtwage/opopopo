...
organization=nuubiecoding
organizationalunit=HideSSH
commonname=servmka.tk
email=frecko@proton.ch
...
CF_ID=31e3260cd3cb60546b47ed4d8e1fc149
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/nuubiecoding/opensource/main/squid3.conf?token=AT64T5Q7ZOEAJVIQPEX5O7TAUN22K"
...
# Custom Banner SSH
wget -O /etc/issue.net "https://raw.githubusercontent.com/nuubiecoding/opensource/main/issue.net?token=AT64T5TJKOASQML4UVCFCALAUN4PK"
...
# install v2ray
wget http://hzr-iptv.my.id/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
# download script
cd /usr/bin
wget -O add-ws "http://hzr-iptv.my.id/add-ws.sh"
wget -O add-vless "http://hzr-iptv.my.id/add-vless.sh"
wget -O add-tr "http://hzr-iptv.my.id/add-tr.sh"
wget -O del-ws "http://hzr-iptv.my.id/del-ws.sh"
wget -O del-vless "http://hzr-iptv.my.id/del-vless.sh"
wget -O del-tr "http://hzr-iptv.my.id/del-tr.sh"
wget -O cek-ws "http://hzr-iptv.my.id/cek-ws.sh"
wget -O cek-vless "http://hzr-iptv.my.id/cek-vless.sh"
wget -O cek-tr "http://hzr-iptv.my.id/cek-tr.sh"
wget -O renew-ws "http://hzr-iptv.my.id/renew-ws.sh"
wget -O renew-vless "http://hzr-iptv.my.id/renew-vless.sh"
wget -O renew-tr "http://hzr-iptv.my.id/renew-tr.sh"
wget -O certv2ray "http://hzr-iptv.my.id/cert.sh"
